...
<body class="bg-gray-50">
    ...
    <section id="home" class="py-12 bg-gradient-to-r from-green-500 to-teal-500 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 max-w-3xl mx-auto">Schedule door-to-door waste collection, reduce your environmental
                footprint, and earn rewards for your contribution to a cleaner planet.</p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#schedule"
                    class="bg-white text-green-500 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold shadow-lg transition-colors">Schedule
                    Pickup</a>
                <a href="#rewards"
                    class="bg-transparent border-2 border-white hover:bg-white hover:text-green-500 px-6 py-3 rounded-lg font-semibold transition-colors">View
                    Rewards</a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Our team will arrive at your doorstep to collect your waste at the
                        scheduled time.</p>
                </div>
                <div class="text-center">
                    <div class="bg-green-100 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-600">Get points for each pickup and redeem them for exciting rewards and
                        coupons.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <p class="text-center text-gray-600 mb-12 max-w-3xl mx-auto">Choose your location, select the waste type,
            and pick a convenient time. We'll handle the rest while you earn points!</p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="waste-type-card cursor-pointer p-4 border rounded-lg text-center"
                         data-type="recyclable" data-points="30">
                    ...
                    <div class="waste-type-card cursor-pointer p-4 border rounded-lg text-center"
                         data-type="organic" data-points="20">
                    ...
                    <div class="waste-type-card cursor-pointer p-4 border rounded-lg text-center"
                         data-type="hazardous" data-points="50">
            ...
            <form id="pickup-form">
                <input type="hidden" name="waste_type" id="form-waste-type">
                <input type="hidden" name="points" id="form-points">

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-gray-700 mb-2" for="area">Your Area</label>
                        <select id="area"
                ...
                <div class="bg-gray-100 p-4 rounded-lg mb-6">
                    <div class="flex items-start mb-4">
                        <div class="flex items-center h-5">
                            <input id="special-instructions-check" type="checkbox"
                                   class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-green-300">
                        </div>
                        <label for="special-instructions-check" class="ml-2 text-sm font-medium text-gray-900">I have
                            special instructions</label>
                    </div>
                    <div id="special-instructions-container" class="hidden">
                        <textarea id="special-instructions" rows="3"
                                  class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                                  placeholder="Any special instructions for the pickup..."></textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit" id="schedule-button"
                            class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
                        Schedule Pickup
                    </button>
                </div>
            </form>
    ...
    <section id="upcoming-pickups" class="py-10 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div id="no-pickups-message" class="text-center py-8">
                ...
                <a href="#schedule" class="inline-block mt-4 text-green-500 hover:text-green-600 font-medium">Schedule
                    your first pickup</a>
            </div>
                        ...
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                    name="time">Time</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                    name="waste type">Waste Type</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                    name="area">Area</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                    name="status">Status</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                    name="actions">Actions</th>
                            </tr>
                        </thead>
    ...
    <section id="rewards" class="py-16 bg-gray-50 rewards-section">
        <div class="container mx-auto px-4">
            ...
            <p class="text-center text-gray-600 mb-8 max-w-3xl mx-auto">Earn points with every waste pickup and redeem
                them for exciting rewards!</p>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">Retail</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button
                                class="redeem-btn bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                data-points="100">Redeem</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded">Food</span>
                        </div>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded">Entertainment</span>
                        </div>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">Environmental</span>
                        </div>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded">Product</span>
                        </div>
                        <p class="text-gray-600 mb-4">A surprise box of eco-friendly products delivered to your door.
                        </p>
                        <div class="flex justify-between items-center">
                            <span class="font-medium text-gray-800">300 points</span>
                            <button
                                class="redeem-btn bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                data-points="300">Redeem</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded">Fashion</span>
                        </div>
            ...
            <div class="mt-12 text-center">
                ...
                <p class="text-gray-600 mb-8 max-w-2xl mx-auto">Based on your waste management habits and preferences,
                    our AI system recommends these rewards:</p>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    <div
                        class="reward-card bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 border-2 border-blue-200">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span
                                    class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">Transport</span>
                            </div>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span
                                    class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">Education</span>
                            </div>
                            <p class="text-gray-600 mb-4">Free entry to a recycling workshop at the community center.
                            </p>
                            <div class="flex justify-between items-center">
                                <span class="font-medium text-gray-800">90 points</span>
                                <button
                                    class="redeem-btn bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                    data-points="90">Redeem</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="about" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                    <p class="text-gray-600 mb-4">EcoCollect is a revolutionary door-to-door waste management system
                        that makes recycling and proper waste disposal effortless for households.</p>
                    <p class="text-gray-600 mb-4">Our mission is to create cleaner communities while rewarding
                        environmentally conscious actions. By scheduling regular pickups through our platform, you
                        contribute to waste reduction and sustainable practices.</p>
                    <p class="text-gray-600 mb-6">We leverage AI technology to optimize collection routes, provide
                        personalized rewards, and analyze waste patterns to continuously improve our service.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#schedule" class="text-gray-400 hover:text-white transition-colors">Schedule
                                Pickup</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Residential Pickup</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Commercial Waste</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">E-Waste Disposal</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Recycling Programs</a>
                        </li>
                    </ul>
                </div>
    ...
    <div id="reward-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-[500px] max-h-[90vh] overflow-y-auto mx-4">
            ...
            <div class="flex justify-end space-x-3">
                <button id="cancel-redeem"
                    class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">Cancel</button>
                <button id="confirm-redeem"
                    class="px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors">Confirm
                    Redemption</button>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-auto">
            ...
            <form id="profile-form" action="" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="profile-name" name="username" placeholder="Enter your full name"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>

                <!-- Email -->
                <div>
                    <label for="profile-email" class="block text-sm font-medium text-gray-700 mb-1">Email
                        Address</label>
                    <input type="email" id="profile-email" name="useremail" placeholder="you@example.com"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>
                ...
                <div>
                    ...
                    <input type="tel" id="profile-phone" name="userphone" placeholder="+1 234 567 8900"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                </div>

                <!-- Address -->
                <div>
                    <label for="profile-address" class="block text-sm font-medium text-gray-700 mb-1">Default
                        Address</label>
                    <textarea id="profile-address" rows="3" name="useraddress" placeholder="Enter your pickup address"
                ...
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 mt-5">
                    <button type="button" name="cancel" id="cancel-profile-button"
...
function initializeWasteTypeSelection() {
    wasteTypeCards.forEach(card => {
        card.addEventListener('click', function () {
            ...
            wasteTypeCards.forEach(c => {
                c.classList.remove('selected', 'border', 'border-green-500');
            });
            // Select current card
            this.classList.add('selected', 'border', 'border-green-500');
            selectedWasteType = {
                type: this.dataset.type,
                points: parseInt(this.dataset.points)
            };
            // Update hidden inputs
            document.getElementById('form-waste-type').value = selectedWasteType.type;
            document.getElementById('form-points').value = selectedWasteType.points;
        });
    });
}
...
function initializeSpecialInstructions() {
    specialInstructionsCheck.addEventListener('change', function () {
        specialInstructionsContainer.classList.toggle('hidden', !this.checked);
    });
}
    ...
    document.getElementById('pickup-form').addEventListener('submit', function (e) {
        ...
        .then(res => {
            if (res.status === 'success') {
                ...
                // Add to scheduled pickups (for UI display)
                const pickup = {
                    id: Date.now(),
                    area: area,
                    address: address,
                ...
                document.getElementById('special-instructions-check').checked = false;
                document.getElementById('special-instructions-container').classList.add('hidden');
                wasteTypeCards.forEach(c => c.classList.remove('selected', 'border', 'border-green-500'));
                selectedWasteType = null;
            } else {
                showNotification(res.message || "Failed to schedule pickup.", "error");
            }
        })
        .catch(err => {
...
function showNotification(message, type = 'info', duration = 3000) {
    ...
    notification.className = `notification p-3 rounded text-white ${bgColor}`;
...
function loadPickupsFromDatabase() {
    fetch('get_pickup.php')
        .then(response => response.json())
        .then(data => {
            if (data.status === 'success') {
                scheduledPickups = data.pickups.map(pickup => ({
                    id: pickup.id,
                    area: pickup.area,
                    address: pickup.address,
                    date: pickup.date,
        ...
        .catch(err => {
            ...
            showNotification('Failed to load pickups.', 'error');
        });
}
